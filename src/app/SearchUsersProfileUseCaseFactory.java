...
import views.SearchUserProfileView;

public class SearchUsersProfileUseCaseFactory {
    public static SearchUserProfileView create(
        ...
        return new SearchUserProfileView(searchUsersViewModel, searchUsersController);
    }
